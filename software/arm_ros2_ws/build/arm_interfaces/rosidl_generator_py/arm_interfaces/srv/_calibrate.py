...
class Metaclass_Calibrate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arm_interfaces.srv import _calibrate
...
class Calibrate(metaclass=Metaclass_Calibrate):
    from arm_interfaces.srv._calibrate import Calibrate_Request as Request
    from arm_interfaces.srv._calibrate import Calibrate_Response as Response
