...
#        self.listener.start()
        ...
        self.current_states = {"base":0.0, "shoulder":0.0}

        #Keyboard Control variables
        self.selected_joint = None
        self.current_targets = {"base":0.0, "shoulder":0.0}
        self.increment = 1.0
        self.joint_ranges = {"base":{"min":(-90.0), "max":(80.0)}, "shoulder":{"min":(-90.0), "max":(78.0)}}
...
#        self.joint_pub.publish(msg)
    ...
    def draw(self, stdscr):
        ...
        stdscr.addstr(10, 0, "Actual Angles")
        stdscr.addstr(11, 0, "----------------------------------")
        stdscr.addstr(12, 0, f"Base      : {self.current_states['base']:7.2f}")
        stdscr.addstr(13, 0, f"Shoulder  : {self.current_states['shoulder']:7.2f}")
        stdscr.refresh()
        pass
